        ...
        ui.nav_panel(
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.input_numeric("event_import_before", "# of Minutes Before Timestamp to Include", 30, min=0),
                    ui.input_numeric("event_import_after", "# of Minutes After Timestamp to Include", 180, min=0),
                ...
                ui.card(
                    ...
                    ui.input_numeric("add_event_before", "# of Minutes Before Time to Include", 30, min=0),
                    ui.input_numeric("add_event_after", "# of Minutes After Time to Include", 180, min=0),
